...
\begin{tabular}{|c|c|c|}
\hline 
\multicolumn{2}{|c|}{Requerimientos de desarrollo} & • \\ 
\hline 
\multicolumn{2}{|c|}{Funcionalidades nuevas} & • \\ 
\hline 
\multicolumn{2}{|c|}{Funcionalidades existentes} & • \\ 
\hline 
\multicolumn{2}{|c|}{Estrategia de pruebas} & • \\ 
\hline 
\multicolumn{3}{|c|}{Pruebas funcionales} \\ 
\hline 
\multicolumn{3}{|c|}{Pruebas no funcionales} \\ 
\hline 
Criterios de inicio & Criterios de suspension & Criterios de aceptación \\ 
\hline 
\multicolumn{2}{|c|}{Entornos y ambientes} & • \\ 
\hline 
\multicolumn{2}{|c|}{Necesidades} & • \\ 
\hline 
\multicolumn{2}{|c|}{Metodologia} & • \\ 
\hline 
\end{tabular} 
\end{adjustbox}
